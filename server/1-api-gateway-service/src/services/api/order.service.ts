...
import { IOrderDocument, IExtendedDelivery, IDeliveredWork, IOrderMessage } from '@colson0x1/tradenexus-shared';
import axios, { AxiosResponse } from 'axios';

export let axiosOrderInstance: ReturnType<typeof axios.create>;

// What i have right here is just the methods that will be used or called
// when the API gateway wants to send to the Order Service.
...
class OrderService {
  ...
  // Orders Service -> order/src/routes/order.ts
