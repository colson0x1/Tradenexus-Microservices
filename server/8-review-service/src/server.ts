...
const securityMiddleware = (app: Application): void => {
  ...
  // that will require the user to be logged in, in review for them to access it
...
const startQueues = async (): Promise<void> => {
  // im exporting this `reviewChannel` because i'll make use of this probably in
...
const startServer = async (app: Application): Promise<void> => {
  try {
    ...
    log.error('error', 'ReviewService startServer() method error', error);
  }
};
