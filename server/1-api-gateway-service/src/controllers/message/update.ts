...
export class Update {
  // chat/src/controllers/update.ts
  public async offer(req: Request, res: Response): Promise<void> {
    ...
    res
      ...
      // What to send in the JSON response is located in the chat/src/controllers/update.ts
      .json({ message: response.data.message, singleMessage: response.data.singleMessage });
  }
